...
export function createStyles(palette: AppPalette, typography: AppTypography) {
  return StyleSheet.create({
    ...
    readerChromeMenuWrap: {
      position: 'absolute',
      right: theme.spacing.lg,
      zIndex: 120,
      elevation: 120,
    },
    readerChromeMenuButton: {
      width: 58,
      height: 58,
      borderRadius: 29,
      alignItems: 'center',
    ...
    courseSupplementGrid: {
      gap: theme.spacing.sm,
      marginTop: 4,
    },
    courseSupplementButton: {
      borderRadius: 18,
      padding: theme.spacing.md,
      gap: 4,
      backgroundColor: palette.surfaceLow,
    ...
    savedNoteAnchorText: {
      ...
      lineHeight: 21,
      borderBottomWidth: 1,
      borderBottomColor: palette.primarySolid,
      paddingBottom: 2,
    },
    ...
    bibleVersionDropdownWrap: {
      gap: 8,
      zIndex: 2,
    },
    bibleVersionDropdownButton: {
      minHeight: 54,
      flexDirection: 'row',
      alignItems: 'center',
      justifyContent: 'space-between',
    ...
    bibleVersionDropdownChevron: {
      color: palette.primarySolid,
      fontFamily: typography.ui,
      fontSize: 22,
      fontWeight: '900',
    },
    bibleVersionDropdownMenu: {
      overflow: 'hidden',
      borderRadius: 18,
      backgroundColor: palette.surfaceLow,
      borderWidth: 1,
    ...
    bibleVersionDropdownOptionActive: {
      backgroundColor: palette.primaryContainer,
    },
    bibleVersionDropdownOptionLabel: {
      color: palette.foreground,
      fontFamily: typography.ui,
      fontSize: 15,
      lineHeight: 19,
    ...
    bibleVersionDropdownOptionLabelActive: {
      color: palette.foreground,
    },
    bibleVersionDropdownOptionName: {
      color: palette.mutedStrong,
      fontFamily: typography.ui,
      fontSize: 12,
      lineHeight: 16,
